...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class ScheduledOverride :  IEquatable<ScheduledOverride>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ScheduledOverride" /> class.
        /// </summary>
        ...
        public ScheduledOverride(string publicId = default(string), ScheduledUser user = default(ScheduledUser), string timezone = default(string), string start = default(string), string end = default(string), List<Assignment> assignments = default(List<Assignment>))
        {
        ...
        public ScheduledUser User { get; set; }
        ...
        {
            return this.Equals(input as ScheduledOverride);
        }

        /// <summary>
        /// Returns true if ScheduledOverride instances are equal
        /// </summary>
        /// <param name="input">Instance of ScheduledOverride to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ScheduledOverride input)
        {
            if (input == null)
                return false;
