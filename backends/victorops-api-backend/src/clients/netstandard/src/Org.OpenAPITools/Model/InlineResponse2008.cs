...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineResponse2008 :  IEquatable<InlineResponse2008>, IValidatableObject
    {
        ...
        public InlineResponse2008(List<ScheduledOverride> overrides = default(List<ScheduledOverride>), string selfUrl = default(string))
        {
        ...
        public List<ScheduledOverride> Overrides { get; set; }
