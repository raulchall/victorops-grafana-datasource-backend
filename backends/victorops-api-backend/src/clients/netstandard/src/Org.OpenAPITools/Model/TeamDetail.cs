...
namespace Org.OpenAPITools.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class TeamDetail :  IEquatable<TeamDetail>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TeamDetail" /> class.
        /// </summary>
        ...
        /// <param name="isDefaultTeam">isDefaultTeam.</param>
        public TeamDetail(string selfUrl = default(string), string membersUrl = default(string), string policiesUrl = default(string), string adminsUrl = default(string), string name = default(string), string slug = default(string), decimal memberCount = default(decimal), decimal version = default(decimal), bool isDefaultTeam = default(bool))
        {
        ...
        /// <summary>
        /// Gets or Sets IsDefaultTeam
        /// </summary>
        [DataMember(Name="isDefaultTeam", EmitDefaultValue=false)]
        ...
        public override string ToString()
        {
            ...
            sb.Append("  IsDefaultTeam: ").Append(IsDefaultTeam).Append("\n");
            sb.Append("}\n");
            return sb.ToString();
        }
        ...
        {
            return this.Equals(input as TeamDetail);
        }

        /// <summary>
        /// Returns true if TeamDetail instances are equal
        /// </summary>
        /// <param name="input">Instance of TeamDetail to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TeamDetail input)
        {
            if (input == null)
                return false;
            ...
            return 
                ...
                (
                    this.IsDefaultTeam == input.IsDefaultTeam ||
                    this.IsDefaultTeam.Equals(input.IsDefaultTeam)
                );
        }
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                hashCode = hashCode * 59 + this.IsDefaultTeam.GetHashCode();
                return hashCode;
            }
        }
