...
namespace Org.OpenAPITools.Model
{
    ...
    public partial class InlineResponse2002 :  IEquatable<InlineResponse2002>, IValidatableObject
    {
        ...
        /// </summary>
        /// <param name="timeoutTypes">timeoutTypes.</param>
        /// <param name="selfUrl">selfUrl.</param>
        public InlineResponse2002(List<TimeoutObject> timeoutTypes = default(List<TimeoutObject>), string selfUrl = default(string))
        {
        ...
        /// <summary>
        /// Gets or Sets TimeoutTypes
        /// </summary>
        [DataMember(Name="timeoutTypes", EmitDefaultValue=false)]
        public List<TimeoutObject> TimeoutTypes { get; set; }
        ...
        public override string ToString()
        {
            ...
            sb.Append("  TimeoutTypes: ").Append(TimeoutTypes).Append("\n");
        ...
        public bool Equals(InlineResponse2002 input)
        {
            ...
            return 
                (
                    this.TimeoutTypes == input.TimeoutTypes ||
                    this.TimeoutTypes != null &&
                    input.TimeoutTypes != null &&
                    this.TimeoutTypes.SequenceEqual(input.TimeoutTypes)
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.TimeoutTypes != null)
                    hashCode = hashCode * 59 + this.TimeoutTypes.GetHashCode();
